    ...
    <body id="tips-tricks-body">
        ...
        <section id="tips-tricks">
            ...
            <article id="choose-products">
                <router-link v-bind:to="{ name:'products' }"><img :src="ProductImage"/></router-link>
                <h4><router-link v-bind:to="{ name:'products' }">How To Choose Which Cannabis Product Is Right For You</router-link></h4>
                <span>Choosing the right cannabis product is all about matching your mood and goals. Start by picking between sativas for energy, indicas for relaxation, or hybrids for balance by using our <router-link v-bind:to="{ name:'strain-guide' }">strain guide</router-link> to help you figure out what type is best for you. Consider the potency and method—like edibles for longer effects or vaping for quick hits. Experiment and enjoy the journey to find what suits you best!</span>
            </article>

            <!-- Display Strain Guide Link and Information -->
            <article id="strain-guide">
                <router-link v-bind:to="{ name:'strain-guide' }"><img :src="StrainGuideImage"/></router-link>
                <h4><router-link v-bind:to="{ name:'strain-guide' }">Comprehensive Strain Guide To Cannabis Products</router-link></h4>
            ...
            <article id="safety-tips">
                <router-link v-bind:to="{ name:'safety' }"><img :src="SafetyImage"/></router-link>
                <h4><router-link v-bind:to="{ name:'safety' }">Tips for Safer Consumption, Smoking and Topicals</router-link></h4>
            ...
            <article id="too-much">
                <router-link v-bind:to="{ name:'too-much' }"><img :src="TooMuchImage"/></router-link>
                <h4><router-link v-bind:to="{ name:'too-much' }">What To Do If You Have Too Much Cannabis</router-link></h4>
            ...
            <article id="legality">
                <router-link v-bind:to="{ name:'legality' }"><img :src="LegalImage"/></router-link>
            ...
            <article id="questions">
                <router-link v-bind:to="{ name:'questions' }"><img :src="QuestionsImage"/></router-link>
                <h4><router-link v-bind:to="{ name:'questions' }">Commonly Asked Questions</router-link></h4>
...
<script>
import ProductImage from '../../assets/tips-tricks/product.webp';
import StrainGuideImage from '../../assets/tips-tricks/strain-guide.webp';
import SafetyImage from '../../assets/tips-tricks/safety.webp';
import TooMuchImage from '../../assets/tips-tricks/too-much.webp';
import LegalImage from '../../assets/tips-tricks/legal.webp';
import QuestionsImage from '../../assets/tips-tricks/questions.webp';

export default {
    name: "TipsTricksGuide",

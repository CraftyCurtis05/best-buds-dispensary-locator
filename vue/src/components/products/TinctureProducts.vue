...
<script>
import TinctureProductsImage from '../../assets/products/tincture-products.webp';

export default {
    name: "TinctureProducts",

    data() {
        return {
            TinctureProductsImage
        }
    }
};
</script>

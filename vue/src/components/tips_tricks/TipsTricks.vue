    ...
    <body id="tips-tricks-body">
        ...
        <section id="tips-tricks">
            ...
            <article id="choose-products">
                <router-link v-bind:to="{ name:'cannabisproducts' }"><img :src="Product"/></router-link>
            ...
            <article id="strain-guide">
                <router-link v-bind:to="{ name:'strainguide' }"><img :src="StrainGuide"/></router-link>
            ...
            <article id="safety-tips">
                <router-link v-bind:to="{ name:'safetytips' }"><img :src="Safety"/></router-link>
            ...
            <article id="too-much">
                <router-link v-bind:to="{ name:'toomuchcannabis' }"><img :src="TooMuch"/></router-link>
            ...
            <article id="legality">
                <router-link v-bind:to="{ name:'legality' }"><img :src="Legal"/></router-link>
            ...
            <article id="questions">
                <router-link v-bind:to="{ name:'commonquestions' }"><img :src="Questions"/></router-link>
...
<script>
import Product from '../../assets/tips_tricks/product.jpg';
import StrainGuide from '../../assets/tips_tricks/strain-guide.jpg';
import Safety from '../../assets/tips_tricks/safety.jpg';
import TooMuch from '../../assets/tips_tricks/too-much.jpg';
import Legal from '../../assets/tips_tricks/legal.jpg';
import Questions from '../../assets/tips_tricks/questions.jpg';

<!-- What To Do Component Display -->
<template>

    <!-- Display Component Body -->
    <body id="what-to-do-body">
        ...
        <!-- Display Photo -->
        <aside id="photo">
            <img :src="CannabisOveruseGuideImage" />
        </aside>
...
<script>
import CannabisOveruseGuideImage from '../../assets/too-much/cannabis-overuse-guide.webp';

export default {
    name: "CannabisOveruseGuide",

    data() {
        return {
            CannabisOveruseGuideImage
        }
    }
};
</script>

        ...
        <section id="smoking">
            ...
            <ol id="list">
                ...
                <ul id="sub-list">
                    ...
                    <span>Understand the THC and CBD content and the strain type by using our <router-link v-bind:to="{ name:'strainguide' }">strain guide</router-link>.</span>
                    <li>Effects:</li>
...
<script>
import Smoking from '../../assets/safety_tips/smoking.jpg';
